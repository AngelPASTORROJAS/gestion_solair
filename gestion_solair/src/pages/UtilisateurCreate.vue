...
export default defineComponent ({
    ...
    setup() {
        ...
        const isCheck = () => {
            if(!utilisateur.value.identifiant || !utilisateur.value.nom || !utilisateur.value.prenom || !utilisateur.value.mail || !utilisateur.value.password || !utilisateur.value.role) {
                $q.notify({
                    color: 'red-5',
                    textColor: 'white',
                    icon: 'error_outline',
